...
public class RecipeActivity extends Activity {
	...
	protected class GetRecipeTask extends AsyncTask<String, Void, Void> {
		...
		protected void onPostExecute() throws JSONException, IOException {
			JSONArray tmpIngredients = this.recipeJSON
			...
			String sourceUrl = this.recipeJSON.getJSONObject("source")
					.getString("sourceRecipeUrl");

			final String directions = "Preparation instructions available at:\n"
					+ sourceUrl;
